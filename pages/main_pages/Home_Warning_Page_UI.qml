...
Item{
    ...
    Flickable_Page{
        ...
        width: parent.width
        height: parent.height
        title: my_str.page_Names.warnings
        ...
        sourceComponent: Component {
            ...
            Rectangle{
                ...
                Column{ // Создаём Основную Колонку
                    ...
                    Custom_Row_TextField{
                        ...
                        model: [
                             { title: "Начальный километр", text: warning_Page.task_Passport_DB.start_Km, maximumLength: ui.text_Values.km_textLength},
                             { title: "Начальный метр", text: warning_Page.task_Passport_DB.start_M, maximumLength: ui.text_Values.meter_textLength}
                        ]
                    ...
                    Custom_Row_TextField{
                        ...
                        model: [
                             { title: "Конечный километр", text:  warning_Page.task_Passport_DB.end_Km, maximumLength: ui.text_Values.km_textLength},
                             { title: "Конечный метр", text: warning_Page.task_Passport_DB.end_M, maximumLength: ui.text_Values.meter_textLength}
                        ]
                    ...
                    */
                    ...
                    Custom_Button{
                        width: parent.width
                        text:  my_str.add_Add(qsTr("предупреждение"))
            ...
            Custom_Rectangle_Label{
                ...
                text: "Тут будет красивая анимированная иллюстрация!"

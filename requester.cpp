...
void Requester::sendRequest(const QString &apiStr, const handleFunc &funcSuccess, const handleFunc &funcError,Requester::Type type, const QVariantMap &data){
 ...
 //   QString jsondata("{'age': 35}");
   ...
   // QNetworkReply* reply = manager->put(request, jsondata.toUtf8());
